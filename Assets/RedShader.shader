	...
	LOD 0
		...
		Pass
		{
				...
				) : SV_Target
			{
				...
				float4 color17 = IsGammaSpace() ? float4(0.9150943,0,0,0) : float4(0.8176128,0,0,0);
...
Node;AmplifyShaderEditor.ColorNode;17;-354.1458,345.5546;Inherit;False;Constant;_Color0;Color 0;2;0;Create;True;0;0;0;False;0;False;0.9150943,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=43DADE7A9F5462761EF3D2D3F1599DECF7508939