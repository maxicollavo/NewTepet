	...
	LOD 0
		...
		Pass
		{
				...
				) : SV_Target
			{
				...
				float4 color17 = IsGammaSpace() ? float4(0.1943086,1,0,0) : float4(0.03135911,1,0,0);
...
Node;AmplifyShaderEditor.ColorNode;17;-354.1458,345.5546;Inherit;False;Constant;_Color0;Color 0;2;0;Create;True;0;0;0;False;0;False;0.1943086,1,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=0E238AE59924A85C3C6A6A1C7D1E6790A72FA32E