...
public class MousePainter : MonoBehaviour
{
    ...
    public void PaintAtUV(RaycastHit hit)
    {
        Vector2 uv = hit.textureCoord; // 🔥 Esto es lo importante
        ...
        Rect brushRect = new Rect(px - 10, py - 10, 20, 20);
        ...
        rend.GetPropertyBlock(propBlock);
        propBlock.SetTexture("_PaintMask", paintMask); // Reasigna
        rend.SetPropertyBlock(propBlock);
    }
